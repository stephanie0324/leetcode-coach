...
| **Problems Solved** | 0 / 0 |
| **Practice Sessions** | 0 |
| **Last Practiced** | Not yet practiced |
...
*No practice sessions yet. Use `coach judge <problem-file>` to start!*

---

## 🎯 Next Steps

🎯 **Start practicing!** Use `coach practice dynamic-programming` to begin with your first problem.
